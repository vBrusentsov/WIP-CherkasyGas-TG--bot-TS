...
export const counterReadingText = `Для того щоб передати показники лічильнику вам потрібно, вибрати один із перелічених особових рахунків.
Якщо у вас не має переліку то ви можете додати його в через кнопку "Керування особовими рахунками" в головному меню. Дякую`.trim()